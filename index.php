    ...
    <div class="row"> 
                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-info w-100">Search Property</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line  text-center mb-5 style=">What SteveBricks Are</h2></div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Sell your property confidently with our proven marketing strategies and industry expertise."</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Whether you're a seasoned landlord or new to renting, our rental services are designed to 
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Maximize your property's exposure and attract more potential buyers or tenants
                                     with our comprehensive listing solutions</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Trust our legal experts to safeguard your interests and handle any 
                                    legal challenges that arise</p>
                            </div>
                        </div>
                    </div>
                </div>
...
-->
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Ranked as the top choice by discerning clients and industry experts alike, we lead the way in 
                                            real estate excellence.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>With years of expertise in the real estate industry, we bring a wealth of knowledge and a commitment to quality to every transaction</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Trust our experienced agents to guide you through every step of your real estate journey with expertise and professionalism.</p>
									</div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center text-info mb-5">How It Works</h2>
                        </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>"Let's discuss property management strategies and tools that can streamline our operations as landlords. Any tips or resources you've found helpful?</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Let's double-check the files to make sure everything is accurate and up-to-date</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Find it right And get into your Home</p>
                        </div>
                    </div>
                </div>
            </div>
