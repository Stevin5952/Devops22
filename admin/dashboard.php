...
<head>
        ...
        <title>SteveBricks Admin Dashboard</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="row">
						...
						<a href="userlist.php" class="card-link">
							<div class="card">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										...
										<div class="progress-bar" style="background: linear-gradient(to right, #ff4e50, #f9d423); width: 50%;"></div>	
										</div>
									</div>
								</div>
                             </a>
						...
						<div class="col-xl-3 col-sm-6 col-12">
						<a href="useragent.php" class="card-link">
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
						...
						<div class="col-xl-3 col-sm-6 col-12">
						<a href="userbuilder.php" class="card-link">
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
					...
					<div class="row">
						<div class="col-xl-3 col-sm-6 col-12">
						<a href="propertyview.php" class="card-link">
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										<span class="dash-widget-icon bg-primary">
