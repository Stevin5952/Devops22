  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="admin\assets\img\logo\SteveBricksADMIN.png" alt="Logo">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="admin\assets\img\logo\SteveBricksADMIN.png" alt="Logo" width="40" height="40">
					</a>
                </div>
				...
				<ul class="nav user-menu">
					...
					<!-- User Menu -->
					 <h4 style="color:Black;margin-top:13px;text-transform:capitalize;"><?php echo $_SESSION['auser'];?></h4> 
