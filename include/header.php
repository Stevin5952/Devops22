<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <ul class="top-contact list-text-white d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-info mr-1"></i>8088574858</a></li>
                                <li><a href="email.php"><i class="fas fa-envelope text-info mr-1"></i>stevinjoseph2003@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-ligh\ p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images\logo\stevebricks.png" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<a class="btn btn-info d-none d-xl-block" style="border-radius:40px;" href="submitproperty.php">Submit Property</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
